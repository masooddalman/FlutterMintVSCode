export interface AddModuleOption {
  ...
  label: string;
  description: string;
  depNote?: string; // e.g. "Also adds: api"
}

export function generateAddModuleHtml(nonce: string, modules: AddModuleOption[]): string {
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .card-dep { display: block; font-size: 10px; color: var(--vscode-focusBorder); margin-top: 4px; font-style: italic; }
...
<body>
  <div class="wizard">
    ...
    <div class="step visible" id="step-select">
      <h2 class="wizard-title">Add Module</h2>
      <div class="info-banner">
        Shared files (main.dart, app.dart, locator.dart) will be regenerated after adding.
      </div>
      ...
      <div class="actions">
        <button type="button" class="btn btn-primary" disabled id="selectNextBtn">Add Module</button>
      </div>
    </div>
    ...
    <div class="step" id="step-flavors">
      ...
      <div class="warning-banner">
        <strong>Note:</strong> main.dart, app.dart, and locator.dart will be regenerated after adding this module.
      </div>
      <div class="field">
      ...
      <div class="actions">
        ...
        <button type="button" class="btn btn-primary" id="flavorsAddBtn">Add Module</button>
      </div>
    </div>
    ...
    <div class="step" id="step-cicd">
      ...
      <div class="actions">
        ...
        <button type="button" class="btn btn-primary" id="cicdAddBtn">Add Module</button>
      </div>
    </div>

    <!-- STEP: Progress -->
    <div class="step" id="step-progress">
      <h2 class="wizard-title">Adding Module...</h2>
    ...
    <div class="step" id="step-finish">
      ...
      <div class="finish-title" id="finishTitle">Module Added!</div>
  ...
  <script nonce="${nonce}">
    ...
    function onModuleSelected(mod) {
      ...
      if (mod === 'flavors' || mod === 'cicd') {
        selectBtn.textContent = 'Next';
      } else {
        selectBtn.textContent = 'Add Module';
      }
    }
    ...
    document.getElementById('flavorsAddBtn').addEventListener('click', () => {
    ...
    document.getElementById('cicdAddBtn').addEventListener('click', () => {
      startAdd();
    });
    ...
    window.addEventListener('message', event => {
      ...
      switch (msg.type) {
        ...
        case 'complete':
          goToStep('finish');
          document.getElementById('finishTitle').textContent = 'Module Added!';
          document.getElementById('finishSub').textContent = '"' + msg.module + '" has been added to the project.';
          break;
